...
pp = PdfPages(option[var-1]+'/NroTraining_'+numSet[selNumSet]+'-Machine_'+option[var-1]+'-Solve_'+solve[selSolve]+'-CapaOcultaA_'+capaOcultaA+'-CapaOcultaB_'+capaOcultaB+'-learning_rate_init_'+learning_rate_init+'.pdf')
